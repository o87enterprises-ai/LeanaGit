...
export const flyers = [
  ...
  { slug: 'loren-taylor',     name: 'Loren Taylor' },
  ...
  { slug: 'charlene-griffin-johnson', name: 'Charlene Griffin-Johnson' },
  { slug: 'silvia-guzman',    name: 'Silvia Guzmán' },
  { slug: 'maggie-jimenez',   name: 'Maggie Jiménez' },
  { slug: 'cynthia-adams',    name: 'Cynthia Adams' },
  // The flyer pictures Katie; the full endorsement list credits both her and Cody.
  { slug: 'katie-rhodes',     name: 'Katie Rhodes' },
  { slug: 'mahagany-gillam',  name: 'Mahagany Gillam' },
  { slug: 'jerry-wolfe',      name: 'Jerry Wolfe' },
  { slug: 'odiaka-gonzalez',  name: 'Odiaka Gonzalez' },
  { slug: 'andrea-dawson',    name: 'Andrea Dawson' },
  { slug: 'genice-jacobs',    name: 'Genice Jacobs' },
  { slug: 'sheila-haynes',    name: 'Sheila Haynes' },
  { slug: 'erin-armstrong',   name: 'Erin Armstrong' },
  { slug: 'lamar-hancock',    name: 'Lamar Hancock' },
  { slug: 'david-silver',     name: 'David Silver' },
  {
    slug: 'madres-lideres',
